...
class ConfigManager(metaclass=SingletonMeta):
    ...
    def __init__(self) -> None:
        self.TMP_PREFIX = "STORMTMP"
        self.ANNDATA_KEY = "__storm__"
        self.CPU_ONLY = False
